...
values(null, # -> auto increment가 숫자 대입
        ...
        9500,
        4,
        'Y'); # [23000][1048] Column 'menu_name' cannot be null
...
insert into
    tbl_menu(
             ...
             orderable_status,
             menu_name,
             category_code) # menu_code 제외 -> 자동으로 null -> auto increment 적용
values(
       6500,
       'Y',
       '카카오 죽',
...
# - 바꾸고 싶은 컬럼 값이 존재하는 행을 잘 찾는 것이 중요 (where)
/*
    update 테이블명
    set
        컬럼명 = 수정값,
...
values (
        ...
        8,
        'Y'
    ); # update 된 모습 -> 실제로는 delete 후 insert 수행
