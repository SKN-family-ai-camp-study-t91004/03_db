...
# - 데이터베이스 스키마(객체)를 만들고(Create), 수정하고(ALTER), 삭제(DROP)하는 구문
...
# ===========================================
### 제약 조건(constraint)
# - 테이블 컬럼에 붙어 INSERT, UPDATE 시 각 컬럼에 기록되는 값에 대한 조건을 설정하는 방법
...
insert into order_composite_pk
values (2, 1, 5, now()); # PK가 설정된 3 컬럼 모두 같아야 중복으로 판단
...
# [23000][1062] Duplicate entry '3-100-2026-06-12 11:31:41' for key 'order_composite_pk.PRIMARY'
...
# - FK 제약조건 설정 시 두 에티블간의 관계(RELATIONSHIP)이 형성된다
